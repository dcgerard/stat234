...
<<message=FALSE>>=
qplot(satGPA$SATV, xlab="SAT Verbal", bins = 15)
@
\end{frame}
...
<<>>=
qplot(movie$meta, bins = 11)
@
\end{frame}

\begin{frame}[fragile]{Metacritic Score: Maybe some Modality?}
<<>>=
qplot(movie$meta, bins = 21)
@
\end{frame}
