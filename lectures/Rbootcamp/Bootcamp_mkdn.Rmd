...
* We can change the intervals by adding another argument called "breaks."
...
Noticed that I used the `legend()` function to add a legend to the top right of the plot.
...
* Finally let's examine a stem and leaf plot. 
